...
# ==============================================================================
"""Provides data for captured_dataset Dataset with images+labels.
...
_FILE_PATTERN = 'captureddata_%s.tfrecord'


_ITEMS_TO_DESCRIPTIONS = {
    'image': 'A color image of varying height and width.',
    'label': 'The label id of the image, an integer in {0, 1, 2,...}',
}
