...
def download_coco_dataset(dataset_dir):
    ...
    coco_validation_url = 'http://images.cocodataset.org/zips/val2014.zip'
    coco_annotations_url = 'http://images.cocodataset.org/annotations/annotations_trainval2014.zip'
    dataset_utils.download_and_uncompress_zipfile(coco_train_url,
                                                  dataset_dir)
    dataset_utils.download_and_uncompress_zipfile(coco_validation_url,
                                                  dataset_dir)
    dataset_utils.download_and_uncompress_zipfile(coco_annotations_url,
                                                  dataset_dir)
...
def create_visual_wakeword_annotations(annotations_file,
    ...
    with tf.gfile.GFile(annotations_file, 'r') as fid:
        ...
        for annotation in groundtruth_data['annotations']:
            annotations_index[annotation['image_id']
...
def create_tf_record_for_visualwakewords_dataset(annotations_file, image_dir,
    ...
    with contextlib2.ExitStack() as tf_record_close_stack, \
        ...
        print("annotations_index : {}".format(annotations_index))
        annotations_index = {
            int(k): v for k, v in annotations_index.iteritems()}
